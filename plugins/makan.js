...
try {
        ...
        if (global.DATABASE.data.users[m.sender].stamina < 100) {
        	if (global.DATABASE.data.users[m.sender].ayamg >= count * 1) {
                            global.DATABASE.data.users[m.sender].ayamg -= count * 1
                           ////// global.DATABASE.data.users[m.sender].healt += snyawa * count
                            global.DATABASE.data.users[m.sender].stamina += spertamina * count
                            itsu.reply(m.chat, `Nyam nyam`, m)
                            } else itsu.reply(m.chat, `Ayam mu kurang weh` ,m)
        	////} else itsu.reply(m.chat, `dah kenyang lol`, m)
        } else itsu.reply( m.chat, `wes kebek weh`, m)
        } else  if (args.length > 2 && args[0] === !'potion') m.reply('cuman bisa gunain ayamgoreng')
        if (args[0] === 'ayamb') {
        	////if (global.DATABASE.data.users[m.sender].healt < 100) {
        if (global.DATABASE.data.users[m.sender].stamina < 100) {
        	if (global.DATABASE.data.users[m.sender].ayamb >= count * 1) {
        ...
        if (args[0] === 'leleb') {
        	////if (global.DATABASE.data.users[m.sender].healt < 100) {
        if (global.DATABASE.data.users[m.sender].stamina < 100) {
        	if (global.DATABASE.data.users[m.sender].leleb >= count * 1) {
                            global.DATABASE.data.users[m.sender].leleb -= count * 1
                           ///// global.DATABASE.data.users[m.sender].healt += snyawa * count
                            global.DATABASE.data.users[m.sender].stamina += spertamina * count
                            itsu.reply(m.chat, `Nyam nyam`, m)
                            } else itsu.reply(m.chat, `lele bakar mu kurang weh` ,m)
        	/////} else itsu.reply(m.chat, `dah kenyang lol`, m)
        } else itsu.reply( m.chat, `wes kebek weh`, m)
        } else  if (args.length > 2 && args[0] === !'potion') m.reply('cuman bisa gunain ayamgoreng')
        }
