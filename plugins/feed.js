let handler = async (m, { itsu, args, usedPrefix }) => {
    ...
    switch (type) {
        case 'phonix':
            ...
            let __waktur = (new Date - global.DATABASE.data.users[m.sender].phonixlastclaim)
            let _waktur = (600000 - __waktur)
            let waktur = clockString(_waktur)
            if (new Date - global.DATABASE.data.users[m.sender].phonixlastclaim > 600000) {
                if (global.DATABASE.data.users[m.sender].makananpet > 0) {
                    global.DATABASE.data.users[m.sender].makananpet -= 1
                    global.DATABASE.data.users[m.sender].anakphonix += 20
                    global.DATABASE.data.users[m.sender].phonixlastclaim = new Date * 1
                    itsu.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    if (phonix > 0) {
                        let naiklvl = ((phonix * 100) - 1)
                        if (global.DATABASE.data.users[m.sender].anakphonix > naiklvl) {
                            global.DATABASE.data.users[m.sender].phonix += 1
                            global.DATABASE.data.users[m.sender].anakphonix -= (phonix * 100)
                            itsu.reply(m.chat, `*Selamat Pet phonix kamu naik level*`, m)
                        }
                    }
                ...
                if (global.DATABASE.data.users[m.sender].makananpet > 0) {
                    ...
                    if (kuda > 0) {
                        ...
                        if (global.DATABASE.data.users[m.sender].anakkuda > naiklvl) {
                            ...
                            itsu.reply(m.chat, `*Selamat Pet Kuda kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
        ...
        case 'naga':
            ...
            let ___waktuuu = (new Date - global.DATABASE.data.users[m.sender].nagalastclaim)
            let ____waktuuu = (600000 - ___waktuuu)
            let waktuuu = clockString(____waktuuu)
            if (new Date - global.DATABASE.data.users[m.sender].nagalastclaim > 600000) {
                if (global.DATABASE.data.users[m.sender].makananpet > 0) {
                    global.DATABASE.data.users[m.sender].makananpet -= 1
                    global.DATABASE.data.users[m.sender].anaknaga += 20
                    global.DATABASE.data.users[m.sender].kudalastclaim = new Date * 1
                    itsu.reply(m.chat, `Berhasil memberi makan pet ${type}`, m)
                    if (naga > 0) {
                        ...
                        if (global.DATABASE.data.users[m.sender].anaknaga > naiklvl) {
                            ...
                            global.DATABASE.data.users[m.sender].anaknaga -= (naga * 100)
                            itsu.reply(m.chat, `*Selamat Pet Naga kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
            } else m.reply(`Pet kamu sudah kenyang, coba kasih makan *${waktuk}* lagi`)
            ...
            let __waktuu = (new Date - global.DATABASE.data.users[m.sender].rubahlastclaim)
                ...
                if (global.DATABASE.data.users[m.sender].makananpet > 0) {
                    ...
                    if (naga > 0) {
                        ...
                        if (global.DATABASE.data.users[m.sender].anakrubah > naiklvl) {
                            ...
                            itsu.reply(m.chat, `*Selamat Pet rubah kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
            } else m.reply(`Pet kamu sudah kenyang, coba kasih makan *${waktuk}* lagi`)
        ...
        case 'kucing':
                ...
                if (global.DATABASE.data.users[m.sender].makananpet > 0) {
                    ...
                    if (kucing > 0) { 
                        ...
                        if (global.DATABASE.data.users[m.sender].anakkucing > naiklvl) {
                            ...
                            itsu.reply(m.chat, `*Selamat Pet Kucing kamu naik level*`, m)
                        }
                    }
                } else m.reply(`Makanan pet kamu tidak cukup`)
            ...
            break
        default:
            return itsu.reply(m.chat, `${usedPrefix}feed [kucing | phonix | kuda | naga]\nContoh penggunaan: *${usedPrefix}feed kucing*`, m)
    }
}
