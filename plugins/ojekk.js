...
let handler = async (m, { itsu }) => {
    let __timers = (new Date - global.DATABASE.data.users[m.sender].lastngojek)
...
const buttonMessage = {
    ...
    if (new Date - global.DATABASE.data.users[m.sender].lastngojek > 300000) {
...
global.DATABASE.data.users[m.sender].ojekk += 1
