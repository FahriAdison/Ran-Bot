...
let handler = async (m, {itsu, command, args, usedPrefix}) => {
	
let user = global.DATABASE.data.users[m.sender]


let __timers = (new Date - global.DATABASE.data.users[m.sender].lastsda)
...
if (new Date - global.DATABASE.data.users[m.sender].lastsda > 480000) {
if ( user.troops > 50 ) {
