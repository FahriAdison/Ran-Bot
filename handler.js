          ...
          if (user.includes(this.user.jid)) return // biar ngga nyambut diri sendiri, kalo simulasi harus tag yang lain
           ...
           let ppgc = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
            try {
              ...
              this.sendButtonImg(jid, action === 'add' ? wel.toBuffer() : lea.toBuffer(), text, action === 'add' ? 'Welcome Message' : 'Leave Message', action === 'add' ? 'Selamat Datang👋' : 'Selamat Tinggal👋',action === 'add' ? 'Selamat Datang👋' : 'Selamat Tinggal👋', {
key: {
fromMe: false,
...
▸ Contoh : #daftar ${user}.13`*/
  ...
  if (msg) return itsu.relayWAMessage(itsu.prepareMessageFromContent(m.chat, {
        "listMessage": {
          "title": msg,
          "description": des,
          ...
          "sections": [
                    ...
                    "title": "Ran_2022"
                     ...
                     }, {quoted: m, contexInfo: { mentionedJid: itsu.parseMention(fot)}}), {waitForAck: true})
...
📮 Silahkan Klik tombol dibawah, dan pilih umur anda!`
  ...
  if (msgg) return itsu.relayWAMessage(itsu.prepareMessageFromContent(m.chat, {
        "listMessage": {
          "title": titreg,
          "description": msgg,
          "footerText": global.botdate,
