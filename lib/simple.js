...
exports.smsg = (conn, m, hasParent) => {
  ...
  if (m.message) {
    ...
    m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: itsu.parseMention(text), externalAdReply: { title: 'ꜱɪᴍᴩʟᴇ ᴡʜᴀᴛꜱᴀᴩᴩ ʙᴏᴛ', body: '© Relldev', sourceUrl: 'https://wa.me/c/6283820073017', thumbnail: data }}, options })
    }
    /**
     * Copy this message
     */
