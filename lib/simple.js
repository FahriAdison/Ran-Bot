...
exports.smsg = async (itsu, m, hasParent) => {
  ...
  if (m.message) {
    ...
    m.reply = async (text, chatId, options) => {
        ...
        itsu.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: itsu.parseMention(text), externalAdReply: { title: 'ꜱɪᴍᴩʟᴇ ᴡʜᴀᴛꜱᴀᴩᴩ ʙᴏᴛ', body: '© Ran_2022', sourceUrl: 'https://chat.whatsapp.com/JA15OE9XxsJ4KXYJmsUK66', thumbnail: data }}, options })
    }
    /**
     * Copy this message
     */
